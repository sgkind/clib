...
sset_find__(const sset_t *set, const char *name, size_t hash)
{
...
static struct sset_node *
sset_add__(sset_t *set, const char *name, size_t length, size_t hash)
{
...
void
sset_clone(sset_t *set, const sset_t *orig)
{
    struct sset_node *node;
...
void
sset_from_delimited_string(sset_t *set, const char *s_,
 ...
 * string. */
bool
sset_is_empty(const sset_t *set)
{
...
struct sset_node *
sset_add(sset_t *set, const char *name)
{
...
struct sset_node *
sset_add_and_free(sset_t *set, char *name)
{
 ...
 * 'set'. */
void
sset_add_assert(sset_t *set, const char *name)
{
...
void
sset_add_array(sset_t *set, char **names, size_t n)
{
    size_t i;
...
void
sset_delete(sset_t *set, struct sset_node *node)
{
...
bool
sset_find_and_delete(sset_t *set, const char *name)
{
 ...
 * in 'set'. */
void
sset_find_and_delete_assert(sset_t *set, const char *name)
{
 ...
 * pointer. */
struct sset_node *
sset_find(const sset_t *set, const char *name)
{
...
bool
sset_contains(const sset_t *set, const char *name)
{
...
bool
sset_equals(const sset_t *a, const sset_t *b)
{
    struct sset_node *node;
...
struct sset_node *
sset_at_position(const sset_t *set, struct sset_position *pos)
{
...
void
sset_intersect(sset_t *a, const sset_t *b)
{
    const char *name, *next;
